...
// FlutterWebView(){}
    ...
    FlutterWebView(
            ...
            final Activity activity, BinaryMessenger messenger,
            int id,
...
//    webView.setWebChromeClient(new FlutterWebChromeClient());
        webView.setWebChromeClient(new FlutterWebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("image/*");
                FlutterWebView.this.activity.startActivityForResult(Intent.createChooser(i, "File Chooser"), FILECHOOSER_RESULTCODE);
            ...
            public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                FlutterWebView.this.activity.startActivityForResult(
